...
// ============================================
// CARROSSEL MOBILE - CATÁLOGO E VÍDEOS
// ============================================
...
// ============================================
// POPULAR CARROSSÉIS COM PRODUTOS E VÍDEOS
// ============================================

function populateCarousels() {
    // Produtos do catálogo
    const products = document.querySelectorAll('.product-card');
    const catalogCarousel = document.querySelector('.carousel-catalog .carousel-items');
    
    if (catalogCarousel && products.length > 0) {
        products.forEach(product => {
            const clonedProduct = product.cloneNode(true);
            const carouselItem = document.createElement('div');
            carouselItem.className = 'carousel-item';
            carouselItem.appendChild(clonedProduct);
            catalogCarousel.appendChild(carouselItem);
        });
    }
    
    // Vídeos
    const videoCards = document.querySelectorAll('.video-card');
    const videosCarousel = document.querySelector('.carousel-videos .carousel-items');
    
    if (videosCarousel && videoCards.length > 0) {
        videoCards.forEach(video => {
            const clonedVideo = video.cloneNode(true);
            const carouselItem = document.createElement('div');
            carouselItem.className = 'carousel-item';
            carouselItem.appendChild(clonedVideo);
            videosCarousel.appendChild(carouselItem);
        });
    }
}
